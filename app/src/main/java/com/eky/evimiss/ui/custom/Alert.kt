...
fun Alert(
    ...
    confirmButtonText: String? = stringResource(com.eky.evimiss.R.string.label_confirm),
    onConfirm: (() -> Unit)? = null,
    dismissButtonText: String? = stringResource(com.eky.evimiss.R.string.label_dismiss),
    onDismiss: (() -> Unit)? = null,
) {
